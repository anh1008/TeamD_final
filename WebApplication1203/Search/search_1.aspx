...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    &nbsp;<asp:LinkButton ID="LinkButton2" runat="server" BackColor="Yellow" BorderColor="White" ForeColor="Black" OnClick="LinkButton2_Click">Product(ID)</asp:LinkButton>
&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#FF9966" DataKeyNames="Product_ID" DataSourceID="SqlDataSource1" Height="500px" Width="1600px">
        <Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Search_By_ProductID %>" SelectCommand="SELECT * FROM [Products] WHERE ([Product_ID] = @Product_ID)">
        <SelectParameters>
            <asp:ControlParameter ControlID="Search_box" Name="Product_ID" PropertyName="Text" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </p>
</asp:Content>
